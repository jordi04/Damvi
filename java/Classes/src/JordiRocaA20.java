    ...
    public static void main(String[] args) {
        ...
        */
        ...
        for (int i = 0; i < persones.length; ++i) {
            System.out.print("Persona num #" + (i+1));
        ...
        for (int i = 0; i < persones.length; ++i) {
            System.out.printf("\n\nLa persona %s %s %s té %d anys i fa %f d'altura",persones[i].nom, persones[i].primerCognom, persones[i].segonCognom, persones[i].edat, persones[i].altura);
        }
