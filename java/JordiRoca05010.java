...
*/
public class JordiRoca05010 {
    public static void main(String[] args) {
        long[] vector = new long[50];
        Scanner scanner = new Scanner(System.in); 
        for (int i = 0; i < 50; ++i){ //Cream el vector seguint les normes de la succesió de Fibonacci
            if (i < 2) {
                vector[i] = 1;
            }
        ...
        int i = 0;
        while (i < 50) { //Comprovam si forma part del vector
